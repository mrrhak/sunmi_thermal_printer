...
public class BitmapUtil {
    ...
    /**
     * Generate QR code The address or string to be converted, it can be Chinese
     *
     * @param url
     * @param width
     * @param height
    ...
    public static Bitmap createQRImage(String url, final int width, final int height) {
        try {
            // Judging the legitimacy of the URL
            ...
            int[] pixels = new int[width * height];
            // Here, according to the algorithm of the two-dimensional code, the pictures of the two-dimensional code are generated one by one.
            ...
            // The format for generating a QR code image, using ARGB_8888
    ...
    /**
     * Check if the picture exceeds a certain value, if yes, zoom out
     */
    public static Bitmap convertToThumb(byte[] buffer, float size)
    {
        ...
        if (bm != null && !bm.isRecycled())
        {
            bm.recycle();
            bm = null;
            Log.e("bitmap", "convertToThumb, recycle");
        }
