...
import com.mrrhak.sunmi_thermal_printer.utils.InnerPrinterUtil;
import com.mrrhak.sunmi_thermal_printer.utils.Base64Utils;
import com.mrrhak.sunmi_thermal_printer.utils.BitmapUtil;
import com.mrrhak.sunmi_thermal_printer.utils.ESCUtil;

import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;

public class SunmiThermalPrinterModule {
  ...
  public void row(String colsStr, boolean bold, boolean underline, int textSize, int linesAfter) {
    try {
      ...
      Log.d("SunmiThermalPrinter", err.getMessage());
    }
  }
