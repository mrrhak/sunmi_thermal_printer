...
import 'package:sunmi_thermal_printer/src/sunmi_thermal_column.dart';
import 'package:sunmi_thermal_printer/src/sunmi_thermal_size.dart';
import 'package:sunmi_thermal_printer/src/sunmi_thermal_style.dart';
...
class SunmiThermalPrinter {
  ...
  static Future<void> text(
    String text, {
    SunmiThermalStyles styles = const SunmiThermalStyles(),
    int linesAfter = 0,
  }) async {
  ...
  static Future<void> row({
    required List<SunmiThermalColumn> cols,
    bool bold: false,
    bool underline: false,
    SunmiThermalSize textSize: SunmiThermalSize.md,
    int linesAfter: 0,
  }) async {
    ...
    final colsJson = List<Map<String, String>>.from(cols
        .map<Map<String, String>>((SunmiThermalColumn col) => col.toJson()));
  ...
  static Future<void> image(
    String base64, {
    SunmiThermalAlign align: SunmiThermalAlign.center,
  }) async {
